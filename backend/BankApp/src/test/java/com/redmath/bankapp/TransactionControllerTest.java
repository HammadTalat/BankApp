...
class TransactionControllerTest {
  ...
  class LookupAccountTests {
    ...
    void lookupAccount_Success() throws Exception {
      ...
      AccountLookupResponse mockResponse = new AccountLookupResponse(accountId, "John Doe",
  ...
  class GetUserTransactionsTests {
    ...
    void getUserTransactions_Authenticated_Success() throws Exception {
      UserTransactionsResponse mockResponse = new UserTransactionsResponse(Collections.emptyList(),
          0, 10, 0L, true);

      given(transactionService.getUserTransactions(any(Jwt.class), nullable(LocalDate.class),
