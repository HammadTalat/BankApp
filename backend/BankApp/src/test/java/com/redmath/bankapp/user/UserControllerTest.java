...
client = HttpClient.newBuilder()
    ...
    private JsonNode post(String path, String body, String contentType, boolean authenticated) throws Exception {
        String email = null;
    ...
    private void establishSession(String email, String password) throws Exception {
        ...
        System.err.println("ESTABLISH SESSION SET-COOKIE: " + loginResponse.headers().allValues("Set-Cookie"));
    ...
    class CompleteProfileTests {
        ...
        void completeProfile_ValidAddress_ReturnsUpdatedProfile() throws Exception {
            ...
            JsonNode response = post("/api/v1/me/complete-profile", requestBody, "application/json", true);
