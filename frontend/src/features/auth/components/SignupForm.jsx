...
function SignupForm({ onSubmit, isSubmitting = false }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <button type="submit" disabled={isSubmitting} className="w-full rounded-xl bg-brand-primary px-4 py-3 font-semibold text-white shadow-sm transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60">{isSubmitting ? "Creating account…" : "Create account"}</button>
