...
export const DepositPage = () => {
    ...
    // Fetch primary account number on load
    useEffect(() => {
        let isMounted = true;

        const loadAccountDetails = async () => {
            try {
                const data = await depositApi.getAccountDetails();
    ...
    const handleDeposit = async (e) => {
        ...
        try {
            const response = await depositApi.deposit({
                accountNumber,
                amount: parsedAmount,
            ...
            setSuccessMessage(
                response?.message || `Successfully deposited ${formatCurrency(parsedAmount)} into your account.`
            );
                ...
                <form onSubmit={handleDeposit} className="space-y-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {PRESET_AMOUNTS.map((preset) => (
                                <button
                                    ...
                                    className={`px-3.5 py-2 text-xs font-semibold rounded-lg border transition-colors disabled:opacity-50 cursor-pointer ${
                    ...
                    <div className="pt-4 flex items-center gap-4">
                        <button
                            ...
                            className="bg-[#2563EB] hover:bg-blue-700 text-white font-semibold text-sm px-8 py-3 rounded-xl transition-colors shadow-sm disabled:opacity-50 flex items-center gap-2 cursor-pointer"
                        >
                            {submitting ? (
                                <>
                        ...
                        <button
                            ...
                            className="bg-gray-50 hover:bg-gray-100 text-gray-700 font-semibold text-sm px-6 py-3 rounded-xl border border-gray-200 transition-colors cursor-pointer"
                        >
                            Back to Dashboard
                        </button>
                    </div>
