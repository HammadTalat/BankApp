            ...
            <div className="mx-auto flex min-h-20 w-full max-w-[1600px] items-center gap-3 px-4 sm:px-6 lg:px-8">
                ...
                >
                    <button
                        ...
                        aria-label={`${profileOpen ? "Close" : "Open"} administrator profile`}
                    ...
                    >
                        <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-blue-50 text-brand-primary ring-1 ring-blue-100">
                            <UserRound
                                size={21}
                                aria-hidden="true"
                            />
